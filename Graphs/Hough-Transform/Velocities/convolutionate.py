...
def convolutionated(fibras):
    ...
    # 3.1) CARGA DE DATOS
    # ----------------------------------------------------------------------------
    json_file = f"Particle-Tracking-Velocimetry\\Hough-Transform\\fibras_{fibras}_filtrado.json"
    output_file = f"Graphs/Hough-Transform/Velocities/fibers_{fibras}_convolutionated.json"
