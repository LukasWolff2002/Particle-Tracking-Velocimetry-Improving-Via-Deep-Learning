...
def graficar (fibras):
    with open(f"C:\\Users\\MBX\\Desktop\\Investigacion\\Particle-Tracking-Velocimetry-Improving-Via-Deep-Learning\\Particle-Tracking-Velocimetry\\YOLO\\fibras_{fibras}_filtrado.json", "r") as file:
        data = json.load(file)
